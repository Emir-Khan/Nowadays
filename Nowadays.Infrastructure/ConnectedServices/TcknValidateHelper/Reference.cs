...
namespace TcknValidateHelper
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="Services.KPSPublicSoap")]
    internal interface KPSPublicSoap
    {
        ...
        System.Threading.Tasks.Task<TcknValidateHelper.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(TcknValidateHelper.TCKimlikNoDogrulaRequest request);
    }
    ...
    internal partial class TCKimlikNoDogrulaRequest
    {
        ...
        public TcknValidateHelper.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(TcknValidateHelper.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    internal partial class TCKimlikNoDogrulaResponse
    {
        ...
        public TcknValidateHelper.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(TcknValidateHelper.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    internal interface KPSPublicSoapChannel : TcknValidateHelper.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    internal partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<TcknValidateHelper.KPSPublicSoap>, TcknValidateHelper.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<TcknValidateHelper.TCKimlikNoDogrulaResponse> TcknValidateHelper.KPSPublicSoap.TCKimlikNoDogrulaAsync(TcknValidateHelper.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<TcknValidateHelper.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            TcknValidateHelper.TCKimlikNoDogrulaRequest inValue = new TcknValidateHelper.TCKimlikNoDogrulaRequest();
            inValue.Body = new TcknValidateHelper.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((TcknValidateHelper.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
